...
{
    /// <summary>
    /// A Godot int rect2 converter.
    /// </summary>
    public class Rect2IConverter : VectorConverter<Rect2I, int>
    {
        /* Protected method. */
        protected override int GetLength() => 4;

        protected override int GetElementAt(ref Rect2I vector, int index)
        {
            switch (index)
            {
        ...
        protected override void SetElementAt(ref Rect2I vector, int index, ref int element)
        {
            switch (index)
            {
