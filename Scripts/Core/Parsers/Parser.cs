...
namespace Rusty.Serialization.Core.Parsing
{
    ...
    public abstract class Parser
    {
        ...
        /// </summary>
        protected static Token ExpectToken(TextSpan text, Lexer lexer, string errorMessage)
        {
        ...
        /// </summary>
        protected static Token ExpectSymbol(TextSpan text, Lexer lexer, char symbol, string errorMessage)
        {
