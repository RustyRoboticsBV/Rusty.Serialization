...
namespace Rusty.Serialization.Converters.System
{
    ...
    {
        /* Protected methods. */
        protected override TimeNode ConvertValue(DateTime obj, IConverterScheme scheme, SymbolTable table) => new(new(obj));
        protected override DateTime DeconvertValue(TimeNode node, IConverterScheme scheme, ParsingTable table)
