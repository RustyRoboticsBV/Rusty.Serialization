...
public static class UnitTests
{
    ...
    public static void RunParserTests(bool verbose = false, bool numberSequences = false)
    {
        ...
        ParseTester.TestTimestamp("Y1999", new TimestampNode.Timestamp(1999, 0, 0, 0, 0, 0, 0));
        ParseTester.TestTimestamp("M7", new TimestampNode.Timestamp(0, 7, 0, 0, 0, 0, 0));
        ParseTester.TestTimestamp("D31", new TimestampNode.Timestamp(0, 0, 31, 0, 0, 0, 0));
        ParseTester.TestTimestamp("h3", new TimestampNode.Timestamp(0, 0, 0, 3, 0, 0, 0));
        ParseTester.TestTimestamp("m2", new TimestampNode.Timestamp(0, 0, 0, 0, 2, 0, 0));
        ParseTester.TestTimestamp("s1", new TimestampNode.Timestamp(0, 0, 0, 0, 0, 1, 0));
        ParseTester.TestTimestamp("f123", new TimestampNode.Timestamp(0, 0, 0, 0, 0, 0, 123));
        ParseTester.TestTimestamp("D31M7Y1999", new TimestampNode.Timestamp(1999, 7, 31, 0, 0, 0, 0));
        ParseTester.TestTimestamp("-D31M7Y1999", new TimestampNode.Timestamp(-1999, 7, 31, 0, 0, 0, 0));
        ParseTester.TestTimestamp("   \n\tY1999 \t", new TimestampNode.Timestamp(1999, 0, 0, 0, 0, 0, 0));
        ...
        ParseTester.TestType("(i32)", "i32");
        ParseTester.TestType("(i32).", "i32");
        ParseTester.TestType("(  dict<i32,c>[,][])", "dict<i32,c>[,][]");
