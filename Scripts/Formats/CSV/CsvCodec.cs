...
namespace Rusty.Serialization.CSV
{
    ...
    public class CsvCodec : Codec
    {
        ...
        {
            CsvWriterSettings xmlSettings = new CsvWriterSettings
            {
                OmitCsvDeclaration = !settings.IncludeFormatHeader,
            ...
            using CsvWriter writer = CsvWriter.Create(sw, xmlSettings);
        ...
        public override NodeTree Parse(string serialized)
        {
            ...
            if (rootElement == null)
                throw new ArgumentException("CSV does not contain a root element.");
        ...
        private static void WriteNode(CsvWriter writer, INode node)
        {
            // Unwrap IdNode
            string idAttr = null;
        ...
        private static void WriteMetadata(CsvWriter writer, string id, string type)
        {
            if (id != null)
        ...
        private static INode ReadNode(XElement element)
        {
            ...
            else
            {
                node = tag switch
                {
                    ...
                    _ => throw new ArgumentException($"Illegal CSV tag <{tag}>.")
                };
            }
